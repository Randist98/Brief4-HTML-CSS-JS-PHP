...
if(isset($_POST['add_product'])){
   ...
   // $p_image_folder = 'data:image/'.$p_image;
...
if(isset($_POST['update_product'])){
   ...
   $update_query = mysqli_query($con, "UPDATE `product` SET name = '$update_p_name', price = '$update_p_price', image = '$update_p_image' WHERE id = '$update_p_id'");
      ...
      <tbody>
        ...
        // 
         ...
         <tr>
            ...
            <td><?php echo '<img name="product_image" src="data:image/jpeg;base64,'.base64_encode($row['image']).'"height="100" alt="User Image" >' ?></td>
            <!-- <?php echo '<img name="product_image" src="data:image/jpeg;base64,'.base64_encode($fetch_product['image']).'" alt="User Image" >' ?> -->
